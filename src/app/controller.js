  ...
  return (
    <>
      <div className="controller" >
        ...
        <div className="row mb-2">
          <div className="col-md-4"><label htmlFor="j7_rotate_number" className="form-label"><span className="form-control-plaintext">J7 Deg</span></label></div>
          <div className="col-md-8"><input type="number" className="form-control" id="j7_rotate_number" value={j7_rotate} onChange={set_j7_rotate} min={0} max={18}/></div>
        </div>
      </div>
